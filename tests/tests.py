...
from fileTestSuite.formats import binaryFormat, textFormat
from fileTestSuite.unittest import FileTestSuiteTestCaseMixin, withFTS
...
class Tests(unittest.TestCase, FileTestSuiteTestCaseMixin):
	...
	def testWithFts(self, challFile: Path, respFile: Path, paramsDict=None):
		self.assertEqual(challFile.stem, respFile.stem)
